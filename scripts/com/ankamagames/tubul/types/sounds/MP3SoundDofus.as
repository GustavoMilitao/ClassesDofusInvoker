package com.ankamagames.tubul.types.sounds
{
   ...
   public class MP3SoundDofus extends Object implements ISound
   {
      ...
      public function stop(param1:VolumeFadeEffect = null, param2:Boolean = false) : void
      {
         ...
         if(this._soundWrapper != null && param1 && param1.timeFade > 0)
         {
      ...
      private function finishPlay(param1:Boolean = false) : void
      {
         if(this._silence)
         {
            this._silence.clean();

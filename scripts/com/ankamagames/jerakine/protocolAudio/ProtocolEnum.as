package com.ankamagames.jerakine.protocolAudio
{
   ...
   public class ProtocolEnum extends Object
   {
      ...
      public static const FLA_EVENT:String = "handleFLAEvent";
      
      public static const SET_MAIN_CLIENT:String = "setMainClient";
      
      public static const SET_OPTION:String = "setOption";
      
      public static const REMOVE_ALL_SOUNDS:String = "removeAllSounds";
      
      public static const SAY_HELLO:String = "sayHello";
      
      public static const SAY_GOODBYE:String = "sayGoodbye";
      
      public static const SET_VOLUME:String = "setVolume";
      
      public static const SET_FADE_VOLUME:String = "setFadeVolume";
      
      public static const SET_SOUND_PROPERTIES:String = "setSoundProperties";
      
      public static const DYNAMIC_MIX:String = "dynamicMix";
      
      public static const PLAY_INTRO:String = "playIntro";
      
      public static const STOP_INTRO:String = "stopIntro";
      
      public static const SWITCH_INTRO:String = "switchIntro";
      ...
      public static const REG_SHUT_DOWN:String = "regShutDown";

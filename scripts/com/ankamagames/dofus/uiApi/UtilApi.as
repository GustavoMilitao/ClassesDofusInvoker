package com.ankamagames.dofus.uiApi
{
   ...
   public class UtilApi extends Object implements IApi
   {
      ...
      public function sortOnString(param1:*, param2:String = "", param3:Boolean = true) : void
      {
         ...
         if(field)
         {
            list.sort(function(param1:*, param2:*):int
            {
               ...
               return ascending?_loc3_:_loc3_ * -1;
            });
         }
         else
         {
      ...
      [Untrusted]
      public function getSimpleTextureWrapper(param1:String) : SimpleTextureWrapper
      {
         return SimpleTextureWrapper.create(new Uri(param1));
      }
   }
}

package com.ankamagames.dofus.uiApi
{
   ...
   public class JobsApi extends Object implements IApi
   {
      ...
      public function getRecipesByJob(param1:Dictionary, param2:int = 0, param3:int = 0, param4:Boolean = false, param5:int = 8) : Vector.<Recipe>
      {
         ...
         while(_loc9_ < _loc8_)
         {
            ...
            if(!(!_loc10_.job || param3 == 0 && _loc10_.jobId == 1))
            {
               ...
               if(_loc14_ == _loc10_.ingredientIds.length && _loc15_ >= _loc12_ || param5 > 0 && _loc14_ + param5 >= _loc10_.ingredientIds.length)
               {
                  _loc6_.push(_loc10_);
                  ...
                  {
                     SecureCenter.unsecure(param1[_loc10_.resultId]).actualMaxOccurence = _loc16_[0];
                  }
                  if(param4)
                  {
                     _loc19_ = 0;
                     ...
                     SecureCenter.unsecure(param1[_loc10_.resultId]).potentialMaxOccurence = _loc19_;
                  }
               }
            }
            _loc9_++;
      ...
      public function getJobFilteredRecipes(param1:Object, param2:Array, param3:int = 1, param4:int = 1, param5:String = null, param6:int = 0) : Array
      {
         ...
         if(param5)
         {
            var param5:String = StringUtils.noAccent(param5).toLowerCase();
         }

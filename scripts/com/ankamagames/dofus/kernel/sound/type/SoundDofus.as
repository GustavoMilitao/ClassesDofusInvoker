package com.ankamagames.dofus.kernel.sound.type
{
   ...
   public class SoundDofus extends Object implements ISound, ILocalizedSound
   {
      ...
      public function stop(param1:VolumeFadeEffect = null, param2:Boolean = false) : void
      {
         var _loc3_:Number = -1;
         var _loc4_:Number = -1;
         var _loc5_:Number = -1;
         if(param1 != null)
         {
            _loc3_ = param1.beginningValue;
            _loc4_ = param1.endingValue;
            _loc5_ = param1.timeFade;
         }
         RegConnectionManager.getInstance().send(ProtocolEnum.STOP_SOUND,this._id,_loc3_,_loc4_,_loc5_,param2);
      }

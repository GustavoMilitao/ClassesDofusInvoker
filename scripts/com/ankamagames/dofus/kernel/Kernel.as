   ...
   public class Kernel extends Object
   {
      ...
      public static function panic(param1:uint = 0, param2:Array = null) : void
      {
         ...
         else
         {
            ...
            _loc6_.tipSelectable = true;
            _loc6_.enableTipsScrollBar = true;
            _loc6_.tip = PanicMessages.getMessage(param1,param2);
      ...
      public function initOptions() : void
      {
         ...
         _loc1_.swfPath = LangManager.getInstance().getEntry("config.gfx.path.world.swf");

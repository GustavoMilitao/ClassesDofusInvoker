package com.ankamagames.dofus.internalDatacenter.spells
{
   ...
   public dynamic class SpellWrapper extends Proxy implements ISlotData, IClonable, ICellZoneProvider, IDataCenter
   {
      ...
      private function getCriticalHitProbability() : Number
      {
         ...
         var _loc2_:int = this._spellLevel["criticalHitProbability"] > 0?55 - this._spellLevel["criticalHitProbability"]:0;
         if(_loc1_)
         {
            _loc3_ = _loc1_.value.contextModif + _loc1_.value.objectsAndMountBonus + _loc1_.value.alignGiftBonus + _loc1_.value.base + _loc1_.value.additionnal;
            return _loc2_ > 0?_loc2_ - _loc3_:0;
         }
         return _loc2_;
      }

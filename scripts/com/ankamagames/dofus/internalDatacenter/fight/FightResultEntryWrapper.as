         ...
         switch(true)
         {
            case param1 is FightResultPlayerListEntry:
               ...
               else
               {
                  ...
                  if(param2 is GameFightCharacterInformations)
                  {
                     this.breed = (param2 as GameFightCharacterInformations).breed;
                     this.gender = int((param2 as GameFightCharacterInformations).sex);
                  }
                  this.type = 0;
            ...
            case param1 is FightResultFighterListEntry:
               ...
               else if(param2 is GameFightCompanionInformations)
               {

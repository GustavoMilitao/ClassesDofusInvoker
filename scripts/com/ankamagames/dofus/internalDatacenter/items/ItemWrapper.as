package com.ankamagames.dofus.internalDatacenter.items
{
   ...
   public class ItemWrapper extends Item implements ISlotData, ICellZoneProvider, IDataCenter
   {
      ...
      public static function create(param1:uint, param2:uint, param3:uint, param4:uint, param5:Vector.<ObjectEffect>, param6:Boolean = true) : ItemWrapper
      {
         ...
         var _loc9_:ItemWrapper = param2 > 0?_cache[param2]:_cacheGId[param3];
         if(!_loc9_ || !param6)
         {
            if(_loc8_.isWeapon)
            {
         ...
         _loc7_.wrapperObjectCategory = 0;
      ...
      public function get isObjectWrapped() : Boolean
      {
         ...
         for each(_loc1_ in this.effectsList)
         {
            if(_loc1_.actionId == ACTION_ID_WRAPPER_OBJECT_GID)
            {
               this._wrapperItemSkinGID = (_loc1_ as ObjectEffectInteger).value;
               return true;
            }
         }
         return false;
      ...
      public function get spellZoneEffects() : Vector.<IZoneShape>
      {
         ...
         {
            _loc3_ = new ZoneEffect(uint(_loc2_.zoneSize),_loc2_.zoneShape);
            _loc1_.push(_loc3_);
         }
         return _loc1_;
      }
         ...
         if(PlayedCharacterManager.getInstance())
         {
            ...
            if(_loc2_ && _loc3_.favoriteSubAreas.indexOf(_loc2_.id) != -1)
            {
               if(_loc3_.favoriteSubAreas && _loc3_.favoriteSubAreas.length && _loc3_.favoriteSubAreasBonus)
               {
                  ...
                  {
                     if(_loc5_ is EffectInstanceInteger && _loc5_.bonusType == 1)
                     {
                        _loc4_ = _loc5_.clone();
      ...
      public function update(param1:uint, param2:uint, param3:uint, param4:uint, param5:Vector.<ObjectEffect>) : void
      {
         ...
         var _loc6_:Item = Item.getItemById(param3);
      ...
      public function getIconUri(param1:Boolean = true) : Uri
      {
         ...
         {
            _loc4_ = Item.getItemById(this._wrapperItemSkinGID);
            _loc3_ = _loc4_?_loc4_.iconId.toString():"error_on_item_" + this.objectGID + ".png";
         }
         else if(this.isMimicryObject)
         {
            _loc5_ = Item.getItemById(this._mimicryItemSkinGID);
            _loc3_ = _loc5_?_loc5_.iconId.toString():"error_on_item_" + this.objectGID + ".png";
         }
         else
         {
      ...
      public function clone(param1:Class = null) : ItemWrapper
      {
         ...
         _loc2_.wrapperObjectCategory = this.wrapperObjectCategory;
      ...
      private function updateEffects(param1:Vector.<ObjectEffect>) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc6_.effectId == ACTION_ID_WRAPPER_OBJECT_CATEGORY)
            {
               this.wrapperObjectCategory = EffectInstanceInteger(_loc6_).value;
            }
         }
      }
   }

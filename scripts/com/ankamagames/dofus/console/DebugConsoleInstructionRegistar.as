package com.ankamagames.dofus.console
{
   ...
   public class DebugConsoleInstructionRegistar extends Object implements ConsoleInstructionRegistar
   {
      ...
      public function registerInstructions(param1:ConsoleHandler) : void
      {
         ...
         param1.addHandler(["crc32","md5","antibot"],new CryptoInstructionHandler());
         param1.addHandler(["displaymap","displaymapdebug","getmapcoord","getmapid","testatouin","mapid","showcellid","playerjump","showtransitions","groundcache","removeblackbars","setmaprenderscale","capturemap"],new DisplayMapInstructionHandler());
         param1.addHandler(["clearscene","clearentities","countentities"],new ClearSceneInstructionHandler());
         param1.addHandler(["inspector","uiinspector","inspectuielement","inspectuielementsos","modulelist","loadui","unloadui","clearuicache","setuiscale","useuicache","uilist","reloadui","fps","getmoduleinfo","chatoutput","debugwebreader"],new UiHandlerInstructionHandler());
         ...
         param1.addHandler(["connectionstatus","inspecttraffic","inspectlowtraffic"],new ConnectionInstructionHandler());
         ...
         param1.addHandler(["addmovingcharacter","setanimation","setdirection","memorylog","bot-spectator","bot-fight","tiphon-error","fpsmanager","tacticmode"],new BenchmarkInstructionHandler());
         param1.addHandler(["sendaction","listactions","sendhook"],new ActionsInstructionHandler());
         param1.addHandler(["debuglos","calculatepath","tracepath","debugcellsinline"],new IAInstructionHandler());
         param1.addHandler(["setspellscriptparam","setspellscript"],new FightInstructionHandler());
         param1.addHandler(["playmusic","stopmusic","playambiance","stopambiance","addsoundinplaylist","stopplaylist","playplaylist","activesounds","adduisoundelement","clearsoundcache"],new SoundInstructionHandler());

   ...
   public class EffectInstance extends Object implements IDataCenter
   {
      ...
      public function get category() : int
      {
         if(this._category == UNDEFINED_CATEGORY)
         {
            ...
            this._category = this._effectData?this._effectData.category:-1;
         }
      ...
      public function get order() : int
      {
         if(this._order == 0)
         {
            ...
            this._order = this._effectData?this._effectData.effectPriority:0;
         }
         return this._order;
      }
      ...
      public function get bonusType() : int
      {
         if(this._bonusType == -2)
         {
            ...
            this._bonusType = this._effectData?this._effectData.bonusType:-2;
         }
      ...
      public function get oppositeId() : int
      {
         if(this._oppositeId == -1)
         {
            ...
            this._oppositeId = this._effectData?this._effectData.oppositeId:-1;
         }
         ...
         if(param1.indexOf("#") != -1)
         {
            ...
            switch(param2)
            {
               ...
               case 1160:
                  ...
                  break;
               case 1175:
                  _loc4_[0] = "{spellNoLvl," + _loc4_[0] + "," + _loc4_[1] + "}";
                  break;
               case 406:
               ...
               case 806:
                  ...
                  else if(this is EffectInstanceInteger && _loc4_[0] > 6)
                  {
               ...
               case 951:
               case 952:
                  _loc5_ = _loc4_[2] != null?SpellState.getSpellStateById(_loc4_[2]):SpellState.getSpellStateById(_loc4_[0]);
                  if(_loc5_)
                  {
                     if(_loc5_.isSilent)
                     {
                     ...
                     _loc4_[2] = _loc5_.name;
                  }
                  else
                  {
                     _loc4_[2] = UNKNOWN_NAME;
                  }
                  break;
               case 961:
               case 962:
               ...
               case 808:
               case 983:
                  if(_loc4_[0] == undefined && _loc4_[1] == undefined && _loc4_[2] > 0)
                  {
                     _loc4_[0] = _loc4_[2];
                     break;
                  }
                  if(_loc4_[0] == null && _loc4_[1] == null && _loc4_[2] == null)
                  {
                     break;
                  }
                  _loc4_[2] = _loc4_[2] == undefined?0:_loc4_[2];
                  _loc6_ = _loc4_[0];
                  _loc7_ = _loc4_[1].substr(0,2);
                  _loc8_ = _loc4_[1].substr(2,2);
                  _loc9_ = _loc4_[2].substr(0,2);
                  _loc10_ = _loc4_[2].substr(2,2);
                  _loc11_ = XmlConfig.getInstance().getEntry("config.lang.current");
                  switch(_loc11_)
                  {
                     case LanguageEnum.LANG_FR:
                        _loc4_[0] = _loc8_ + "/" + _loc7_ + "/" + _loc6_ + " " + _loc9_ + ":" + _loc10_;
                        break;
                     case LanguageEnum.LANG_EN:
                        _loc4_[0] = _loc7_ + "/" + _loc8_ + "/" + _loc6_ + " " + _loc9_ + ":" + _loc10_;
                        break;
                     default:
                        _loc4_[0] = _loc7_ + "/" + _loc8_ + "/" + _loc6_ + " " + _loc9_ + ":" + _loc10_;
                  }

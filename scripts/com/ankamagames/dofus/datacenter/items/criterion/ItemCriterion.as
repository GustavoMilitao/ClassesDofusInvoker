      ...
      public function get text() : String
      {
         ...
         switch(this._criterionRef)
         {
            ...
            case "Ct":
               ...
               break;
            default:
               _loc1_ = StringUtils.replace(this._criterionRef,["CS","Cs","CV","Cv","CA","Ca","CI","Ci","CW","Cw","CC","Cc","PG","PJ","Pj","PM","PA","PN","PE","<NO>","PS","PR","PL","PK","Pg","Pr","Ps","Pa","PP","PZ","CM","Qa","CP","ca","cc","ci","cs","cv","cw"],I18n.getUiText("ui.item.characteristics").split(","));
         }

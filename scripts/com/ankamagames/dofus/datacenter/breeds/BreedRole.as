package com.ankamagames.dofus.datacenter.breeds
{
   ...
   public class BreedRole extends Object implements IDataCenter
   {
      ...
      public static function getBreedRoleById(param1:int) : BreedRole
      {
         return GameData.getObject(MODULE,param1) as BreedRole;
      }

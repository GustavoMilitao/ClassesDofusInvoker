package com.ankamagames.dofus.misc.lists
{
   ...
   public class HookList extends Object
   {
      ...
      public static const ServerConnectionStarted:Hook = new Hook("ServerConnectionStarted",true);
      ...
      public static const RemoveAllFlags:Hook = new Hook("RemoveAllFlags",false);
      ...
      public static const IdolSelectError:Hook = new Hook("IdolSelectError",false);
      
      public static const IdolSelected:Hook = new Hook("IdolSelected",false);
      
      public static const IdolAdded:Hook = new Hook("IdolAdded",false);
      
      public static const IdolRemoved:Hook = new Hook("IdolRemoved",false);
      
      public static const IdolPartyRefresh:Hook = new Hook("IdolPartyRefresh",false);
      
      public static const IdolPartyLost:Hook = new Hook("IdolPartyLost",false);
      
      public static const IdolsList:Hook = new Hook("IdolsList",false);
      
      public static const IdolsPresetsUpdate:Hook = new Hook("IdolsPresetsUpdate",false);
      
      public static const IdolsPresetDelete:Hook = new Hook("IdolsPresetDelete",false);
      
      public static const IdolsPresetEquipped:Hook = new Hook("IdolsPresetEquipped",false);
      
      public static const IdolsPresetSaved:Hook = new Hook("IdolsPresetSaved",false);
      
      public static const StopableSoundEndend:Hook = new Hook("StopableSoundEnded",false);

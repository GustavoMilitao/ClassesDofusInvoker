package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightLifeVariationStep extends AbstractStatContextualStep implements IFightStep
   {
      ...
      override public function start() : void
      {
         ...
         var _loc3_:CharacterCharacteristicsInformations = CurrentPlayedFighterManager.getInstance().getCharacteristicsInformations(_targetId);
         if(_loc3_)
         {
            _loc3_.lifePoints = _loc1_.stats.lifePoints;
            _loc3_.maxLifePoints = _loc1_.stats.maxLifePoints;
         }

package com.ankamagames.dofus.logic.game.fight.steps.abstract
{
   ...
   public class AbstractStatContextualStep extends AbstractSequencable
   {
      ...
      public function AbstractStatContextualStep(param1:uint, param2:String, param3:int, param4:uint, param5:Boolean = true)
      {
         super();
         this._color = param1;
         this._value = param2;
         this._targetId = param3;
         this._gameContext = param4;
         this._blocking = param5;
      }
      ...
      override public function start() : void
      {
         ...
         {
            this._ccm = CharacteristicContextualManager.getInstance().addStatContextual(this._value,DofusEntities.getEntity(this._targetId),new TextFormat("Verdana",24,this._color,true),OptionManager.getOptionManager("tiphon").pointsOverhead,this._gameContext);
         }
         if(!this._ccm)
         {
            executeCallbacks();

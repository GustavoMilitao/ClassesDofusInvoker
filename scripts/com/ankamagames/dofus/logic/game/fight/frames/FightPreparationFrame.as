         ...
         switch(true)
         {
            case param1 is GameFightLeaveMessage:
               ...
               if(_loc5_.charId == PlayedCharacterManager.getInstance().id)
               {
                  ...
                  _loc36_ = new GameFightEndMessage();
                  _loc36_.initGameFightEndMessage();
                  _loc37_ = Kernel.getWorker().getFrame(FightContextFrame) as FightContextFrame;
                  if(_loc37_)
                  {
            ...
            case param1 is CellClickMessage:
               ...
               if(_loc9_)
               {
                  ...
                  _loc41_ = new Object();
                  _loc41_.name = this._fightContextFrame.getFighterName(_loc9_.id);
                  ...
                  else if(_loc42_.contextualId != _loc2_.contextualId && _loc42_.teamId == _loc2_.teamId)
                  {
               ...
               else if(this.isValidPlacementCell(_loc8_.cellId,this._playerTeam))
               {
                  ...
                  _loc43_.initGameFightPlacementPositionRequestMessage(_loc8_.cellId);
            ...
            case param1 is GameFightPlacementSwapPositionsCancelledMessage:
               ...
               if(_loc4_)
               {
                  ...
                  {
                     _loc3_ = Kernel.getWorker().getFrame(FightEntitiesFrame) as FightEntitiesFrame;
                     _loc46_ = _loc3_.getEntityInfos(_loc22_.cancellerId) as GameFightFighterInformations;
            ...
            case param1 is EntityClickMessage:
               ...
               if(_loc26_)
               {
                  _loc39_ = UiModuleManager.getInstance().getModule("Ankama_ContextMenu").mainClass;
                  _loc41_ = new Object();
                  _loc41_.name = this._fightContextFrame.getFighterName(_loc26_.id);
                  _loc3_ = Kernel.getWorker().getFrame(FightEntitiesFrame) as FightEntitiesFrame;

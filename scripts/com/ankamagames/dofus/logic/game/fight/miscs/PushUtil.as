package com.ankamagames.dofus.logic.game.fight.miscs
{
   ...
   public class PushUtil extends Object
   {
      ...
      public static function isPushableEntity(param1:GameFightFighterInformations) : Boolean
      {
         ...
         var _loc2_:FighterStatus = FightersStateManager.getInstance().getStatus(param1.contextualId);
         var _loc3_:* = true;
         if(param1 is GameFightMonsterInformations)
         {
            _loc4_ = Monster.getMonsterById((param1 as GameFightMonsterInformations).creatureGenericId);
            _loc3_ = _loc4_.canBePushed;
         }
         return !_loc2_.cantBeMoved && _loc3_;
      }
   }
}

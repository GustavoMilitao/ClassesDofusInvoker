package com.ankamagames.dofus.logic.game.fight.managers
{
   ...
   public class TacticModeManager extends Object
   {
      ...
      private static var TILES_REACHABLE:Array = ["Dalle01","Dalle02"];
         ...
         else
         {
            ...
            while(_loc3_ < _loc4_)
            {
               ...
               if(!_loc7_.isDisabled)
               {
                  ...
                  else if(_loc12_ && !this.canMoveOnThisCell(_loc11_,_loc13_,_loc14_))
                  {
            ...
            this._tacticReachableRangeSelection.renderer = new ZoneClipRenderer(PlacementStrataEnums.STRATA_NO_Z_ORDER,SWF_LIB,TILES_REACHABLE,-1,SHOW_BLOC_MOVE);
      ...
      private function getCellZone(param1:int) : int
      {
         ...
         else if(!_loc5_ && !_loc4_ && param1 - 13 > 0 && this._cellZones[param1 - 13] > 0)
         {
            _loc2_ = this._cellZones[param1 - 13];
         }
         else if(_loc5_ && (!_loc3_ || _loc3_ && !_loc5_) && param1 - 14 > 0 && this._cellZones[param1 - 14] > 0)
         {

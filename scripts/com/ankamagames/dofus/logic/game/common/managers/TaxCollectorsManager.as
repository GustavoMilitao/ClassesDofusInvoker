package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class TaxCollectorsManager extends Object implements IDestroyable
   {
      ...
      public function addPrism(param1:PrismFightersInformation) : void
      {
         ...
         for each(_loc4_ in param1.allyCharactersInformations)
         {
            _loc2_.push(_loc4_);
         }
         for each(_loc4_ in param1.enemyCharactersInformations)
         {
            _loc3_.push(_loc4_);
         }
         _loc5_ = param1.waitingForHelpInfo.timeLeftBeforeFight * 100 + getTimer();
         this._prismsInFight[param1.subAreaId] = SocialEntityInFightWrapper.create(TYPE_PRISM,param1.subAreaId,_loc2_,_loc3_,_loc5_,param1.waitingForHelpInfo.waitTimeForPlacement * 100,param1.waitingForHelpInfo.nbPositionForDefensors);
      }

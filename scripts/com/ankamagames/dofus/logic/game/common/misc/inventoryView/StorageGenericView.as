package com.ankamagames.dofus.logic.game.common.misc.inventoryView
{
   ...
   public class StorageGenericView extends Object implements IStorageView
   {
      ...
      {
         var _loc4_:ItemWrapper = param1.clone();
         _loc4_.quantity = _loc4_.quantity - param2;
         this._content.unshift(_loc4_);
         if(this._sortedContent)
         {
            this._sortedContent.unshift(_loc4_);
         }
      ...
      protected function getItemIndex(param1:ItemWrapper, param2:Vector.<ItemWrapper> = null) : int
      {
         ...
         if(param2 == null)
         {
            var param2:Vector.<ItemWrapper> = this._content;
         }
         var _loc3_:* = 0;

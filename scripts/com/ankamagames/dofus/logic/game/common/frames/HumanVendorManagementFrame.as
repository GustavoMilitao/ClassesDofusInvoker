      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is ExchangeStartOkHumanVendorMessage:
               ...
               KernelEventsManager.getInstance().processCallback(ExchangeHookList.ExchangeStartOkHumanVendor,_loc4_,this._shopStock,EntitiesLooksManager.getInstance().getTiphonEntityLook(_loc2_.sellerId));
               return true;

package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class AbstractEntitiesFrame extends Object implements Frame
   {
      ...
      public function addOrUpdateActor(param1:GameContextActorInformations, param2:IAnimationModifier = null) : AnimatedCharacter
      {
         ...
         var _loc9_:EntityLook = null;
         var _loc10_:GameRolePlayHumanoidInformations = null;
         ...
         if(param1.contextualId == PlayedCharacterManager.getInstance().id)
         {
            if(this._creaturesMode || this._creaturesFightMode)
            {
               ...
               if(PlayedCharacterManager.getInstance().infos.entityLook.bonesId != _loc8_.bonesId)
               {
         ...
         if(_loc3_ == null)
         {
            ...
            if(param1.contextualId == PlayedCharacterManager.getInstance().id)
            {
               _loc9_ = EntityLookAdapter.toNetwork(_loc5_);
               if(!EntityLookAdapter.fromNetwork(PlayedCharacterManager.getInstance().infos.entityLook).equals(_loc5_))
               {
                  PlayedCharacterManager.getInstance().infos.entityLook = _loc9_;
         ...
         {
            _loc10_ = param1 as GameRolePlayHumanoidInformations;
            if(param1.contextualId == PlayedCharacterManager.getInstance().id)
            {
               PlayedCharacterManager.getInstance().restrictions = _loc10_.humanoidInfo.restrictions;
            }
         }
         ...
         if(!_loc3_.slideOnNextMove && param1.disposition.cellId != -1)
         {

package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class LivingObjectFrame extends Object implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         var _loc19_:WrapperObjectErrorMessage = null;
         var _loc20_:WrapperObjectAssociatedMessage = null;
         var _loc21_:ItemWrapper = null;
         var _loc22_:WrapperObjectDissociateRequestAction = null;
         var _loc23_:WrapperObjectDissociateRequestMessage = null;
         ...
         switch(true)
         {
            ...
            case param1 is ObjectModifiedMessage:
               ...
               else if(_loc9_.livingObjectId != 0)
               {
            ...
            case param1 is MimicryObjectFeedAndAssociateRequestAction:
               ...
               _loc11_.initMimicryObjectFeedAndAssociateRequestMessage(_loc10_.mimicryUID,_loc10_.symbiotePos,_loc10_.hostUID,_loc10_.hostPos,_loc10_.foodUID,_loc10_.foodPos,_loc10_.preview);
            ...
            case param1 is MimicryObjectErrorMessage:
               ...
               if(_loc14_.reason == ObjectErrorEnum.SYMBIOTIC_OBJECT_ERROR)
               {
                  switch(_loc14_.errorCode)
                  {
                     case -1:
                        _loc24_ = I18n.getUiText("ui.error.state");
                        break;
                     case -2:
                        _loc24_ = I18n.getUiText("ui.charSel.deletionErrorUnsecureMode");
                        break;
                     case -7:
                        _loc24_ = I18n.getUiText("ui.mimicry.error.foodType");
                        break;
                     case -8:
                        _loc24_ = I18n.getUiText("ui.mimicry.error.foodLevel");
                        break;
                     case -9:
                        _loc24_ = I18n.getUiText("ui.mimicry.error.noValidMimicry");
                        break;
                     case -10:
                        _loc24_ = I18n.getUiText("ui.mimicry.error.noValidHost");
                        break;
                     case -11:
                        _loc24_ = I18n.getUiText("ui.mimicry.error.noValidFood");
                        break;
                     case -16:
                        _loc24_ = I18n.getUiText("ui.mimicry.error.noMimicryAssociated");
                        break;
                     case -17:
                        _loc24_ = I18n.getUiText("ui.mimicry.error.sameSkin");
                        break;
                     case -3:
                     case -4:
                     case -5:
                     ...
                     case -14:
                     case -15:
                        _loc24_ = I18n.getUiText("ui.popup.impossible_action");
                        break;
                     default:
                        _loc24_ = I18n.getUiText("ui.common.unknownFail");
                  }
                  if(_loc14_.preview)
                  {
                     KernelEventsManager.getInstance().processCallback(LivingObjectHookList.MimicryObjectPreview,null,_loc24_);
                  }
                  else
                  {
            ...
            case param1 is MimicryObjectEraseRequestAction:
               ...
               return true;
            case param1 is WrapperObjectErrorMessage:
               _loc19_ = param1 as WrapperObjectErrorMessage;
               if(_loc19_.reason == ObjectErrorEnum.SYMBIOTIC_OBJECT_ERROR)
               {
                  switch(_loc19_.errorCode)
                  {
                     case -1:
                        _loc25_ = I18n.getUiText("ui.error.state");
                        break;
                     case -2:
                        _loc25_ = I18n.getUiText("ui.charSel.deletionErrorUnsecureMode");
                        break;
                     case -7:
                        _loc25_ = I18n.getUiText("ui.mimicry.error.foodType");
                        break;
                     case -8:
                        _loc25_ = I18n.getUiText("ui.mimicry.error.invalidWrapperObject");
                        break;
                     case -10:
                        _loc25_ = I18n.getUiText("ui.mimicry.error.noValidHost");
                        break;
                     case -16:
                        _loc25_ = I18n.getUiText("ui.mimicry.error.noWrapperAssociated");
                        break;
                     case -18:
                        _loc25_ = I18n.getUiText("ui.mimicry.error.noAssociationWithLivingObject");
                        break;
                     case -19:
                        _loc25_ = I18n.getUiText("ui.mimicry.error.alreadyWrapped");
                        break;
                     case -3:
                     case -4:
                     case -6:
                     ...
                     case -14:
                     case -15:
                        _loc25_ = I18n.getUiText("ui.popup.impossible_action");
                        break;
                     default:
                        _loc25_ = I18n.getUiText("ui.common.unknownFail");
                  }
               ...
               return true;
            case param1 is WrapperObjectAssociatedMessage:
               _loc20_ = param1 as WrapperObjectAssociatedMessage;
               _loc21_ = InventoryManager.getInstance().inventory.getItem(_loc20_.hostUID);
               KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,I18n.getUiText("ui.mimicry.success",[_loc21_.name]),ChatActivableChannelsEnum.PSEUDO_CHANNEL_INFO,TimeManager.getInstance().getTimestamp());
               return true;
            case param1 is WrapperObjectDissociateRequestAction:
               _loc22_ = param1 as WrapperObjectDissociateRequestAction;
               _loc23_ = new WrapperObjectDissociateRequestMessage();
               _loc23_.initWrapperObjectDissociateRequestMessage(_loc22_.hostUID,_loc22_.hostPosition);

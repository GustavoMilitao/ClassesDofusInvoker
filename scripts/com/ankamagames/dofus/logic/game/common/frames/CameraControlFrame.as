package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class CameraControlFrame extends Object implements Frame
   {
      ...
      private function updateElementsPositions(param1:Event) : void
      {
         ...
         var _loc7_:FightPreparationFrame = null;
         if(this._container.x != this._containerLastX || this._container.y != this._containerLastY)
         {
            ...
            _loc6_ = HyperlinkDisplayArrowManager.getArrowClip();
            if(_loc6_ && HyperlinkDisplayArrowManager.getArrowStrata() != 5)
            {
               _loc6_.x = _loc6_.x + _loc2_;
               _loc6_.y = _loc6_.y + _loc3_;
            }
            _loc7_ = Kernel.getWorker().getFrame(FightPreparationFrame) as FightPreparationFrame;
            if(_loc7_)
            {

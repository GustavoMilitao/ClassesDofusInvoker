         ...
         switch(true)
         {
            ...
            case param1 is TreasureHuntMessage:
               ...
               for each(_loc82_ in _loc54_.flags)
               {
                  ...
                  if(_loc55_.worldMap > -1)
                  {
                     KernelEventsManager.getInstance().processCallback(HookList.AddMapFlag,"flag_hunt_" + _loc54_.questType + "_" + _loc57_,I18n.getUiText("ui.treasureHunt.huntType" + _loc54_.questType) + " - " + I18n.getUiText("ui.treasureHunt.hint",[_loc57_]) + " [" + _loc55_.posX + "," + _loc55_.posY + "]",_loc55_.worldMap,_loc55_.posX,_loc55_.posY,this._flagColors[_loc82_.state],false,false,false);
                  }
               }

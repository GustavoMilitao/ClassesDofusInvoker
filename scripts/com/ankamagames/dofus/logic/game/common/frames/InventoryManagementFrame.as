package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class InventoryManagementFrame extends Object implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case msg is InventoryContentAndPresetMessage:
               ...
               for each(idolsPreset in icapmsg.idolsPresets)
               {
                  idolsPresets.push(IdolsPresetWrapper.create(idolsPreset.presetId,idolsPreset.symbolId,idolsPreset.idolId));
               }
      ...
      private function getShortcutWrapperPropFromShortcut(param1:Shortcut) : Object
      {
         ...
         else if(param1 is ShortcutObjectIdolsPreset)
         {
            _loc2_ = (param1 as ShortcutObjectIdolsPreset).presetId;
            _loc4_ = 5;
         }
         return {
            "id":_loc2_,

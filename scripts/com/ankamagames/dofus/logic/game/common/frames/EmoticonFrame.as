         ...
         switch(true)
         {
            ...
            case param1 is EmotePlayMessage:
               ...
               else
               {
                  ...
                  _loc32_ = _loc31_.getSubEntity(SubEntityBindingPointCategoryEnum.HOOK_POINT_CATEGORY_MOUNT_DRIVER,0);
                  _loc33_ = _loc30_.getAnimName(_loc32_?_loc32_:_loc31_);
                  _loc34_ = _loc30_.persistancy;
                  _loc35_ = _loc30_.eight_directions;
                  this.roleplayEntitiesFrame.currentEmoticon = _loc17_.emoteId;
                  this.roleplayEntitiesFrame.process(new GameRolePlaySetAnimationMessage(_loc18_,_loc33_,_loc17_.emoteStartTime,!_loc34_,_loc35_));
               }
               return true;
            case param1 is EmotePlayMassiveMessage:
               ...
               for each(_loc36_ in _loc19_.actorIds)
               {
                  _loc37_ = this.roleplayEntitiesFrame.getEntityInfos(_loc36_);
                  if(_loc19_.emoteId == 0)
                  {
                     this.roleplayEntitiesFrame.process(new GameRolePlaySetAnimationMessage(_loc37_,AnimationEnum.ANIM_STATIQUE));
                  }
                  else
                  {
                     _loc38_ = EntityLookAdapter.fromNetwork(_loc37_.look);
                     _loc39_ = Emoticon.getEmoticonById(_loc19_.emoteId).getAnimName(TiphonUtility.getLookWithoutMount(_loc38_));
                     _loc40_ = Emoticon.getEmoticonById(_loc19_.emoteId).persistancy;
                     _loc41_ = Emoticon.getEmoticonById(_loc19_.emoteId).eight_directions;
                     this.roleplayEntitiesFrame.currentEmoticon = _loc19_.emoteId;
                     this.roleplayEntitiesFrame.process(new GameRolePlaySetAnimationMessage(_loc37_,_loc39_,_loc19_.emoteStartTime,!_loc40_,_loc41_));
                  }
               }
               return true;
            ...
            case param1 is LifePointsRegenEndMessage:
               ...
               if(this._bEmoteOn)
               {
                  ...
                  {
                     _loc42_ = I18n.getUiText("ui.common.emoteRestoreLife",[_loc23_.lifePointsGained]);

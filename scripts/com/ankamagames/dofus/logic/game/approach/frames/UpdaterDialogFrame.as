package com.ankamagames.dofus.logic.game.approach.frames
{
   ...
   public class UpdaterDialogFrame extends Object implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         var _loc11_:DownloadErrorMessage = null;
         switch(true)
         {
            ...
            case param1 is DownloadErrorMessage:
               _loc11_ = param1 as DownloadErrorMessage;
               KernelEventsManager.getInstance().processCallback(HookList.DownloadError,_loc11_.errorId,_loc11_.message.length > 0?_loc11_.message:null,_loc11_.helpUrl.length > 0?_loc11_.helpUrl:null);
               return true;
            default:
               return false;
         }

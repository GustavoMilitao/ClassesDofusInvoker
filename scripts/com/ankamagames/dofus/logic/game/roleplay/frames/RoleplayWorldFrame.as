package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class RoleplayWorldFrame extends Object implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         var _loc103_:Array = null;
         var _loc104_:CellData = null;
         var _loc105_:MapPoint = null;
         var _loc106_:Object = null;
         var _loc107_:String = null;
         var _loc108_:Skill = null;
         var _loc109_:String = null;
         var _loc110_:String = null;
         var _loc111_:Skill = null;
         var _loc112_:* = false;
         var _loc113_:InteractiveElementWithAgeBonus = null;
         switch(true)
         {
            ...
            case param1 is InteractiveElementActivationMessage:
               ...
               if(!(_loc34_ && _loc34_.usingInteractive))
               {
                  ...
                  _loc100_ = new Array();
                  _loc103_ = MapDisplayManager.getInstance().getDataMapContainer().dataMap.cells;
                  _loc101_ = 0;
                  while(_loc101_ < 8)
                  {
                     _loc102_ = _loc33_.position.getNearestCellInDirection(_loc101_);
                     if(_loc102_)
                     {
                        _loc104_ = _loc103_[_loc102_.cellId];
                        if(!_loc104_.mov || _loc104_.farmCell)
                        {
                           if(!_loc100_)
                           {
                              _loc100_ = [];
                           }
                           _loc100_.push(_loc102_.cellId);
                        }
                     }
                     _loc101_++;
                  }
                  _loc105_ = _loc33_.position.getNearestFreeCellInDirection(_loc33_.position.advancedOrientationTo(_loc99_.position),DataMapProvider.getInstance(),true,true,false,_loc100_);
                  if(!_loc105_ || _loc100_.indexOf(_loc105_.cellId) != -1)
                  {
                     _loc105_ = _loc33_.position;
                  }
                  this.roleplayMovementFrame.setFollowingInteraction({
                     "ie":_loc33_.interactiveElement,
                     "skillInstanceId":_loc33_.skillInstanceId
                  });
                  this.roleplayMovementFrame.askMoveTo(_loc105_);
               }
               return true;
            case param1 is InteractiveElementMouseOverMessage:
               ...
               {
                  _loc106_ = new Object();
                  _loc106_.interactive = _loc41_.name;
                  _loc106_.isCollectable = false;
                  _loc107_ = "";
                  for each(_loc40_ in _loc39_.enabledSkills)
                  {
                     _loc108_ = Skill.getSkillById(_loc40_.skillId);
                     if(_loc108_.elementActionId == ACTION_COLLECTABLE_RESOURCES)
                     {
                        _loc106_.isCollectable = true;
                     }
                     if(_loc40_ is InteractiveElementNamedSkill)
                     {
                        _loc109_ = SkillName.getSkillNameById((_loc40_ as InteractiveElementNamedSkill).nameId).name;
                     }
                     else
                     {
                        _loc109_ = _loc108_.name;
                     }
                     _loc107_ = _loc107_ + (_loc109_ + "\n");
                  }
                  _loc106_.enabledSkills = _loc107_;
                  _loc110_ = "";
                  for each(_loc40_ in _loc39_.disabledSkills)
                  {
                     ...
                     _loc110_ = _loc110_ + (_loc109_ + "\n");
                  }
                  _loc106_.disabledSkills = _loc110_;
                  if(_loc106_.isCollectable)
                  {
                     _loc112_ = true;
                     _loc113_ = _loc39_ as InteractiveElementWithAgeBonus;
                     if(_loc39_.enabledSkills.length > 0)
                     {
                        _loc111_ = Skill.getSkillById(_loc39_.enabledSkills[0].skillId);
                        if(_loc111_.parentJobId == 1)
                        {
                           _loc112_ = false;
                        }
                     }
                     ...
                     if(_loc112_)
                     {
                        _loc106_.collectSkill = _loc111_;
                        _loc106_.ageBonus = _loc113_?_loc113_.ageBonus:0;
                     }
                  }
                  _loc36_ = _loc106_;

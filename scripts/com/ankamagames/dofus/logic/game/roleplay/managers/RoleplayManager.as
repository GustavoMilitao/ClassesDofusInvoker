   ...
   public class RoleplayManager extends Object implements IDestroyable
   {
      ...
      public function getExperienceReward(param1:int, param2:int, param3:int = -1, param4:Number = 1, param5:Number = 1) : int
      {
         ...
         if(param1 > param3)
         {
            ...
            return Math.floor(((1 - REWARD_REDUCED_SCALE) * this.getFixeExperienceReward(param3,param5,param4) + REWARD_REDUCED_SCALE * this.getFixeExperienceReward(_loc7_,param5,param4)) * _loc6_);
         }

package com.ankamagames.dofus.logic.common.managers
{
   ...
   public class HyperlinkMapPosition extends Object
   {
      ...
      public static function rollOver(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         var _loc6_:Rectangle = new Rectangle(param1,param2,10,10);
         var _loc7_:TextTooltipInfo = new TextTooltipInfo(I18n.getUiText("ui.tooltip.chat.position"));

package com.ankamagames.dofus.network.types.game.prism
{
   ...
   public class AllianceInsiderPrismInformation extends PrismInformation implements INetworkType
   {
      ...
      public function initAllianceInsiderPrismInformation(param1:uint = 0, param2:uint = 1, param3:uint = 0, param4:uint = 0, param5:uint = 0, param6:uint = 0, param7:uint = 0, param8:uint = 0, param9:String = "", param10:Vector.<ObjectItem> = null) : AllianceInsiderPrismInformation
      {

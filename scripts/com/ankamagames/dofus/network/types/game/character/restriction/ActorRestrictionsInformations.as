package com.ankamagames.dofus.network.types.game.character.restriction
{
   ...
   public class ActorRestrictionsInformations extends Object implements INetworkType
   {
      ...
      public function serializeAs_ActorRestrictionsInformations(param1:ICustomDataOutput) : void
      {
         var _loc2_:uint = 0;
      ...
      public function deserializeAs_ActorRestrictionsInformations(param1:ICustomDataInput) : void
      {

package com.ankamagames.dofus.network
{
   ...
   public class MessageReceiver extends Object implements RawDataParser
   {
      ...
      
      {
         ...
         _messagesTypes[6606] = IdolsPresetUpdateMessage;
         ...
         _messagesTypes[6604] = IdolsPresetSaveResultMessage;
         _messagesTypes[6173] = InventoryPresetDeleteResultMessage;
         _messagesTypes[6605] = IdolsPresetDeleteResultMessage;
      ...
      public static function register() : void
      {
         ...
         StoreDataManager.getInstance().registerClass(new IdolsPresetUpdateMessage(),true,true);
         ...
         StoreDataManager.getInstance().registerClass(new IdolsPresetSaveResultMessage(),true,true);
         StoreDataManager.getInstance().registerClass(new InventoryPresetDeleteResultMessage(),true,true);
         StoreDataManager.getInstance().registerClass(new IdolsPresetDeleteResultMessage(),true,true);
      ...
      public function parse(param1:ICustomDataInput, param2:uint, param3:uint) : INetworkMessage
      {

package com.ankamagames.dofus.network.messages.connection.search
{
   ...
   public class AcquaintanceSearchErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AcquaintanceSearchErrorMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_AcquaintanceSearchErrorMessage(param1:ICustomDataInput) : void
      {

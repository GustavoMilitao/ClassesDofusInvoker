package com.ankamagames.dofus.network.messages.connection
{
   ...
   public class CredentialsAcknowledgementMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_CredentialsAcknowledgementMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_CredentialsAcknowledgementMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

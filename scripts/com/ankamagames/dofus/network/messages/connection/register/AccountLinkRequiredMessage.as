package com.ankamagames.dofus.network.messages.connection.register
{
   ...
   public class AccountLinkRequiredMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 6607;
      ...
      public function serializeAs_AccountLinkRequiredMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_AccountLinkRequiredMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.connection.register
{
   ...
   public class NicknameAcceptedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_NicknameAcceptedMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_NicknameAcceptedMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

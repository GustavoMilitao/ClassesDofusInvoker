package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class AllianceInsiderInfoRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AllianceInsiderInfoRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_AllianceInsiderInfoRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

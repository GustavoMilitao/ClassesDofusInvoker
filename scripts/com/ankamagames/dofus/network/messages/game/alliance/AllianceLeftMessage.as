package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class AllianceLeftMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AllianceLeftMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_AllianceLeftMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class IgnoredGetListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_IgnoredGetListMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_IgnoredGetListMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

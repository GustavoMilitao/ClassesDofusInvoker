package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class FriendsGetListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_FriendsGetListMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_FriendsGetListMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class FriendWarnOnLevelGainStateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_FriendWarnOnLevelGainStateMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_FriendWarnOnLevelGainStateMessage(param1:ICustomDataInput) : void
      {

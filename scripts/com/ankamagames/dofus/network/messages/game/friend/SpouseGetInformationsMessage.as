package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class SpouseGetInformationsMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_SpouseGetInformationsMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_SpouseGetInformationsMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

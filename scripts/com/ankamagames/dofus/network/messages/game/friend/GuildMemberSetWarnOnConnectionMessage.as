package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class GuildMemberSetWarnOnConnectionMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GuildMemberSetWarnOnConnectionMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_GuildMemberSetWarnOnConnectionMessage(param1:ICustomDataInput) : void
      {

package com.ankamagames.dofus.network.messages.game.friend
{
   ...
   public class FriendSetWarnOnConnectionMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_FriendSetWarnOnConnectionMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_FriendSetWarnOnConnectionMessage(param1:ICustomDataInput) : void
      {

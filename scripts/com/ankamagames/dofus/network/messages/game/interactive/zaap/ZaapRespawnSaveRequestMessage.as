package com.ankamagames.dofus.network.messages.game.interactive.zaap
{
   ...
   public class ZaapRespawnSaveRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ZaapRespawnSaveRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ZaapRespawnSaveRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

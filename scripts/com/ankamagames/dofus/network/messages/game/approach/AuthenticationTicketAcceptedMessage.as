package com.ankamagames.dofus.network.messages.game.approach
{
   ...
   public class AuthenticationTicketAcceptedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AuthenticationTicketAcceptedMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_AuthenticationTicketAcceptedMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.approach
{
   ...
   public class AuthenticationTicketRefusedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AuthenticationTicketRefusedMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_AuthenticationTicketRefusedMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

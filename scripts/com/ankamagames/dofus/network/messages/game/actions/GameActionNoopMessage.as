package com.ankamagames.dofus.network.messages.game.actions
{
   ...
   public class GameActionNoopMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameActionNoopMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameActionNoopMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

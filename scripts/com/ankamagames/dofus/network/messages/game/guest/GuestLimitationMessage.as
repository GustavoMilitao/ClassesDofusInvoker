package com.ankamagames.dofus.network.messages.game.guest
{
   ...
   public class GuestLimitationMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initGuestLimitationMessage(param1:uint = 0) : GuestLimitationMessage
      {
         this.reason = param1;
      ...
      public function serializeAs_GuestLimitationMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_GuestLimitationMessage(param1:ICustomDataInput) : void
      {

package com.ankamagames.dofus.network.messages.game.startup
{
   ...
   public class StartupActionsExecuteMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_StartupActionsExecuteMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_StartupActionsExecuteMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

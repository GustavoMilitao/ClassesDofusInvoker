package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeObjectTransfertAllToInvMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeObjectTransfertAllToInvMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeObjectTransfertAllToInvMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

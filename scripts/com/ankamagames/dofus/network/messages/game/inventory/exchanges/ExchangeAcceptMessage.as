package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeAcceptMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeAcceptMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeAcceptMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

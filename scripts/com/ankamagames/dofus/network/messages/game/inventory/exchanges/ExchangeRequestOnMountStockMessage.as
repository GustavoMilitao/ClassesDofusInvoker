package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeRequestOnMountStockMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeRequestOnMountStockMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeRequestOnMountStockMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

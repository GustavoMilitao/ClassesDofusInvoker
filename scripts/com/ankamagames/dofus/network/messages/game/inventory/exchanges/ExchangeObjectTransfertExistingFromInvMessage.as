package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeObjectTransfertExistingFromInvMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeObjectTransfertExistingFromInvMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeObjectTransfertExistingFromInvMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

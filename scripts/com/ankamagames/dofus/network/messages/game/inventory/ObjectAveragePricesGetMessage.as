package com.ankamagames.dofus.network.messages.game.inventory
{
   ...
   public class ObjectAveragePricesGetMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ObjectAveragePricesGetMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ObjectAveragePricesGetMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeSellOkMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeSellOkMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeSellOkMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

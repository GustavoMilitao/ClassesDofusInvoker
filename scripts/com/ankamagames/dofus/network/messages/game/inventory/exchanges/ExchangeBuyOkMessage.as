package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeBuyOkMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeBuyOkMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeBuyOkMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

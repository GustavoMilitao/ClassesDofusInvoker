package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeObjectMoveMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeObjectMoveMessage(param1:ICustomDataOutput) : void
      {
         if(this.objectUID < 0)
         {
      ...
      public function deserializeAs_ExchangeObjectMoveMessage(param1:ICustomDataInput) : void
      {

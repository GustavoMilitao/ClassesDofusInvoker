package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeReplayStopMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeReplayStopMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeReplayStopMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

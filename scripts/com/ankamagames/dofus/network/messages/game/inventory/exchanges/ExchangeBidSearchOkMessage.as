package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeBidSearchOkMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeBidSearchOkMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeBidSearchOkMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeObjectTransfertExistingToInvMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeObjectTransfertExistingToInvMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeObjectTransfertExistingToInvMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

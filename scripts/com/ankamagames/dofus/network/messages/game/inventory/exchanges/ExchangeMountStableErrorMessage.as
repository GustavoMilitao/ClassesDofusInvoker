package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeMountStableErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeMountStableErrorMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ExchangeMountStableErrorMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

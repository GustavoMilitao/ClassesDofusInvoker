package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeSetCraftRecipeMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeSetCraftRecipeMessage(param1:ICustomDataOutput) : void
      {
         if(this.objectGID < 0)
         {
      ...
      public function deserializeAs_ExchangeSetCraftRecipeMessage(param1:ICustomDataInput) : void
      {

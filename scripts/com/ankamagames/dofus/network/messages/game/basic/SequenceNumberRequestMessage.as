package com.ankamagames.dofus.network.messages.game.basic
{
   ...
   public class SequenceNumberRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_SequenceNumberRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_SequenceNumberRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

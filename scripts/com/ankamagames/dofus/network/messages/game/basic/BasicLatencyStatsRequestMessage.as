package com.ankamagames.dofus.network.messages.game.basic
{
   ...
   public class BasicLatencyStatsRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_BasicLatencyStatsRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_BasicLatencyStatsRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

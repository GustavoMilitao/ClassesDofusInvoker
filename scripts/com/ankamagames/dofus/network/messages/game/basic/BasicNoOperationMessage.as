package com.ankamagames.dofus.network.messages.game.basic
{
   ...
   public class BasicNoOperationMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_BasicNoOperationMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_BasicNoOperationMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

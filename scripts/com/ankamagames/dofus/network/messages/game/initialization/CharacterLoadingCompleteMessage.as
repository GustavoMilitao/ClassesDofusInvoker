package com.ankamagames.dofus.network.messages.game.initialization
{
   ...
   public class CharacterLoadingCompleteMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_CharacterLoadingCompleteMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_CharacterLoadingCompleteMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

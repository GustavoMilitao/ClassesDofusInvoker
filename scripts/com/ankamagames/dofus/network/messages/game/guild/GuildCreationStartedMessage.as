package com.ankamagames.dofus.network.messages.game.guild
{
   ...
   public class GuildCreationStartedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GuildCreationStartedMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GuildCreationStartedMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

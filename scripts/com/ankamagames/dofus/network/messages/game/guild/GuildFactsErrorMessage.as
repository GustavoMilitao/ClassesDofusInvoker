package com.ankamagames.dofus.network.messages.game.guild
{
   ...
   public class GuildFactsErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GuildFactsErrorMessage(param1:ICustomDataOutput) : void
      {
         if(this.guildId < 0)
         {
      ...
      public function deserializeAs_GuildFactsErrorMessage(param1:ICustomDataInput) : void
      {

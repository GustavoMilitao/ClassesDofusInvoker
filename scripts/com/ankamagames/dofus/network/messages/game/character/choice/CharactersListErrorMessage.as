package com.ankamagames.dofus.network.messages.game.character.choice
{
   ...
   public class CharactersListErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_CharactersListErrorMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_CharactersListErrorMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.character.choice
{
   ...
   public class CharacterSelectedErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_CharacterSelectedErrorMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_CharacterSelectedErrorMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

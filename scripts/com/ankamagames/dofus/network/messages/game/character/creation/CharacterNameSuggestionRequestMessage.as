package com.ankamagames.dofus.network.messages.game.character.creation
{
   ...
   public class CharacterNameSuggestionRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_CharacterNameSuggestionRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_CharacterNameSuggestionRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.character.choice
{
   ...
   public class CharacterSelectedForceReadyMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_CharacterSelectedForceReadyMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_CharacterSelectedForceReadyMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

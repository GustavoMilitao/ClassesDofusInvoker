package com.ankamagames.dofus.network.messages.game.idol
{
   ...
   public class IdolSelectedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 6581;
      ...
      public function initIdolSelectedMessage(param1:uint = 0, param2:Boolean = false, param3:Boolean = false) : IdolSelectedMessage
      {
         this.idolId = param1;
      ...
      public function serializeAs_IdolSelectedMessage(param1:ICustomDataOutput) : void
      {
         var _loc2_:uint = 0;
      ...
      public function deserializeAs_IdolSelectedMessage(param1:ICustomDataInput) : void
      {

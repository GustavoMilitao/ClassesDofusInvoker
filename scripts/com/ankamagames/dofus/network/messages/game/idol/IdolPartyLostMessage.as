package com.ankamagames.dofus.network.messages.game.idol
{
   ...
   public class IdolPartyLostMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 6580;
      ...
      public function initIdolPartyLostMessage(param1:uint = 0) : IdolPartyLostMessage
      {
         this.idolId = param1;
      ...
      public function serializeAs_IdolPartyLostMessage(param1:ICustomDataOutput) : void
      {
         if(this.idolId < 0)
         {
      ...
      public function deserializeAs_IdolPartyLostMessage(param1:ICustomDataInput) : void
      {

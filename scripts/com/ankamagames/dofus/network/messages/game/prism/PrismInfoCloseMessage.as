package com.ankamagames.dofus.network.messages.game.prism
{
   ...
   public class PrismInfoCloseMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PrismInfoCloseMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_PrismInfoCloseMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

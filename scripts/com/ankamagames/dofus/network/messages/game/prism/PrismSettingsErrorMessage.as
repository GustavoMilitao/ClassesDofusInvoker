package com.ankamagames.dofus.network.messages.game.prism
{
   ...
   public class PrismSettingsErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PrismSettingsErrorMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_PrismSettingsErrorMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.prism
{
   ...
   public class PrismInfoInValidMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PrismInfoInValidMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_PrismInfoInValidMessage(param1:ICustomDataInput) : void
      {

package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class DungeonPartyFinderRegisterSuccessMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_DungeonPartyFinderRegisterSuccessMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_DungeonPartyFinderRegisterSuccessMessage(param1:ICustomDataInput) : void
      {
         var _loc4_:uint = 0;

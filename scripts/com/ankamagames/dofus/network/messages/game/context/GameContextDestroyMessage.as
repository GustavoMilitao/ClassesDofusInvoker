package com.ankamagames.dofus.network.messages.game.context
{
   ...
   public class GameContextDestroyMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameContextDestroyMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameContextDestroyMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

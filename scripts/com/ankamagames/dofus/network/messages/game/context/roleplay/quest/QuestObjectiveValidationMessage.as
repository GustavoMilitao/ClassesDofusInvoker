package com.ankamagames.dofus.network.messages.game.context.roleplay.quest
{
   ...
   public class QuestObjectiveValidationMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_QuestObjectiveValidationMessage(param1:ICustomDataOutput) : void
      {
         if(this.questId < 0)
         {
      ...
      public function deserializeAs_QuestObjectiveValidationMessage(param1:ICustomDataInput) : void
      {

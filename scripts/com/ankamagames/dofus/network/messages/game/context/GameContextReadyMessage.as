package com.ankamagames.dofus.network.messages.game.context
{
   ...
   public class GameContextReadyMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameContextReadyMessage(param1:ICustomDataOutput) : void
      {
         if(this.mapId < 0)
         {
      ...
      public function deserializeAs_GameContextReadyMessage(param1:ICustomDataInput) : void
      {

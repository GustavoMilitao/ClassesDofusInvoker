package com.ankamagames.dofus.network.messages.game.context
{
   ...
   public class GameContextQuitMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameContextQuitMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameContextQuitMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

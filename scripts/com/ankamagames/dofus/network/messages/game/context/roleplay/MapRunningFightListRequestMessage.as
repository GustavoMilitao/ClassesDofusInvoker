package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class MapRunningFightListRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MapRunningFightListRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_MapRunningFightListRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

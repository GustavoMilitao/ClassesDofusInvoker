package com.ankamagames.dofus.network.messages.game.context.mount
{
   ...
   public class MountInformationInPaddockRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MountInformationInPaddockRequestMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_MountInformationInPaddockRequestMessage(param1:ICustomDataInput) : void
      {

package com.ankamagames.dofus.network.messages.game.context
{
   ...
   public class GameContextCreateErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameContextCreateErrorMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameContextCreateErrorMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.context.mount
{
   ...
   public class MountToggleRidingRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MountToggleRidingRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_MountToggleRidingRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class StopToListenRunningFightRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_StopToListenRunningFightRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_StopToListenRunningFightRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightTurnStartPlayingMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameFightTurnStartPlayingMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameFightTurnStartPlayingMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

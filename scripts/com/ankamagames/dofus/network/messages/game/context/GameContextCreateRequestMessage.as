package com.ankamagames.dofus.network.messages.game.context
{
   ...
   public class GameContextCreateRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameContextCreateRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameContextCreateRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

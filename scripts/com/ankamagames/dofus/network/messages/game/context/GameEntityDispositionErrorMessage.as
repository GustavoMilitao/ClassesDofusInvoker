package com.ankamagames.dofus.network.messages.game.context
{
   ...
   public class GameEntityDispositionErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameEntityDispositionErrorMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameEntityDispositionErrorMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

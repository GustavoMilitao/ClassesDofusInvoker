package com.ankamagames.dofus.network.messages.game.context.roleplay.npc
{
   ...
   public class AlliancePrismDialogQuestionMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AlliancePrismDialogQuestionMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_AlliancePrismDialogQuestionMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

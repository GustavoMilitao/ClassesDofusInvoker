package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class DungeonPartyFinderAvailableDungeonsRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_DungeonPartyFinderAvailableDungeonsRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_DungeonPartyFinderAvailableDungeonsRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

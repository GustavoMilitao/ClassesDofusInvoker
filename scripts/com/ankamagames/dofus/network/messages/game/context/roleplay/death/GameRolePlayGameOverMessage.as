package com.ankamagames.dofus.network.messages.game.context.roleplay.death
{
   ...
   public class GameRolePlayGameOverMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameRolePlayGameOverMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GameRolePlayGameOverMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.game.context.roleplay.quest
{
   ...
   public class QuestStartedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_QuestStartedMessage(param1:ICustomDataOutput) : void
      {
         if(this.questId < 0)
         {
      ...
      public function deserializeAs_QuestStartedMessage(param1:ICustomDataInput) : void
      {

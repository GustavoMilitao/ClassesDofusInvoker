package com.ankamagames.dofus.network.messages.game.context.roleplay.quest
{
   ...
   public class QuestListRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_QuestListRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_QuestListRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

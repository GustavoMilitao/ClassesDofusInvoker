package com.ankamagames.dofus.network.messages.game.context.notification
{
   ...
   public class NotificationResetMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_NotificationResetMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_NotificationResetMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

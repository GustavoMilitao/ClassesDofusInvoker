package com.ankamagames.dofus.network.messages.game.context.mount
{
   ...
   public class MountReleaseRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MountReleaseRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_MountReleaseRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

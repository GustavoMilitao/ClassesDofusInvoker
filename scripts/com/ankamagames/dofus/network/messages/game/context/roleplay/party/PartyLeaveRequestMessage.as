package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class PartyLeaveRequestMessage extends AbstractPartyMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PartyLeaveRequestMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_PartyLeaveRequestMessage(param1:ICustomDataInput) : void
      {

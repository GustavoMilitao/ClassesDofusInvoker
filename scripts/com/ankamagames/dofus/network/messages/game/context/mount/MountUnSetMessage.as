package com.ankamagames.dofus.network.messages.game.context.mount
{
   ...
   public class MountUnSetMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MountUnSetMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_MountUnSetMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

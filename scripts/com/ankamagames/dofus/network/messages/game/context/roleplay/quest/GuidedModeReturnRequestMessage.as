package com.ankamagames.dofus.network.messages.game.context.roleplay.quest
{
   ...
   public class GuidedModeReturnRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GuidedModeReturnRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GuidedModeReturnRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

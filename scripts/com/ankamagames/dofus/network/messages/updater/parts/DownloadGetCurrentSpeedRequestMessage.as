package com.ankamagames.dofus.network.messages.updater.parts
{
   ...
   public class DownloadGetCurrentSpeedRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_DownloadGetCurrentSpeedRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_DownloadGetCurrentSpeedRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

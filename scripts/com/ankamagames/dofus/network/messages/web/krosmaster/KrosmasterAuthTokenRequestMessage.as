package com.ankamagames.dofus.network.messages.web.krosmaster
{
   ...
   public class KrosmasterAuthTokenRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_KrosmasterAuthTokenRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_KrosmasterAuthTokenRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

package com.ankamagames.dofus.network.messages.web.krosmaster
{
   ...
   public class KrosmasterInventoryRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_KrosmasterInventoryRequestMessage(param1:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_KrosmasterInventoryRequestMessage(param1:ICustomDataInput) : void
      {
      }
   }
}

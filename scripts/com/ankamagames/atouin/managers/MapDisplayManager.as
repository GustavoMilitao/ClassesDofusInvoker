package com.ankamagames.atouin.managers
{
   ...
   public class MapDisplayManager extends Object
   {
      ...
      public function fromMap(param1:Map, param2:ByteArray = null, param3:Boolean = true) : uint
      {
         ...
         var _loc4_:RenderRequest = new RenderRequest(this._currentMap,false,param2,param3);
         this._renderRequestStack.push(_loc4_);
         this._currentRenderId = _loc4_.renderId;
         ...
         var _loc5_:ResourceLoadedEvent = new ResourceLoadedEvent(ResourceLoadedEvent.LOADED);
         _loc5_.resource = param1;
         this.onMapLoaded(_loc5_);
         return this._currentRenderId;
      }
      
      public function display(param1:WorldPoint, param2:Boolean = false, param3:ByteArray = null, param4:Boolean = true) : uint
      {
         var _loc5_:RenderRequest = new RenderRequest(param1,param2,param3,param4);
         _log.debug("Ask render map " + param1.mapId + ", renderRequestID: " + _loc5_.renderId);
         this._renderRequestStack.push(_loc5_);
         this.checkForRender();
         return _loc5_.renderId;
      }

package com.ankamagames.berilia.api
{
   ...
   public class UiApi extends Object implements IApi
   {
      ...
      public function getModuleList() : Array
      {
         ...
         _loc4_ = UiModuleManager.getInstance().disabledModules;
      ...
      [Untrusted]
      public function handleComponentRestaureState(param1:GraphicContainer, param2:Array = null) : void
      {
      }
      ...
      public function setModuleEnable(param1:String, param2:Boolean) : void
      {
         ...
         {
            if(_loc5_.id == param1 && _loc5_.enable == !param2)
            {
               _loc5_.enable = param2;
               _loc4_ = true;
               break;
            }
         }
      ...
      public function addShortcutHook(param1:String, param2:Function, param3:Boolean = false) : void
      {
         ...
         var _loc5_:int = this._currentUi?this._currentUi.depth:0;
         if(param3)
         {
            _loc5_ = 1;
         }
         var _loc6_:GenericListener = new GenericListener(param1,this._currentUi?this._currentUi.name:"__module_" + this._module.id,param2,_loc5_,this._currentUi?GenericListener.LISTENER_TYPE_UI:GenericListener.LISTENER_TYPE_MODULE,this._currentUi?new WeakReference(this._currentUi):null);
      ...
      public function removeComponentHook(param1:GraphicContainer, param2:String) : void
      {
         ...
         var _loc4_:InstanceEvent = UIEventManager.getInstance().instances[param1];
         if(_loc4_ && _loc4_.events && _loc4_.events[_loc3_])
         {
      ...
      public function createUri(param1:String) : Uri
      {
         ...
         {
            var param1:String = "mod://" + this._module.id + "/" + param1;
         }
      ...
      public function showTooltip(param1:*, param2:*, param3:Boolean = false, param4:String = "standard", param5:uint = 0, param6:uint = 2, param7:int = 3, param8:String = null, param9:Class = null, param10:Object = null, param11:String = null, param12:Boolean = false, param13:int = 4, param14:Number = 1, param15:String = "") : void
      {
         ...
         {
            _loc16_ = TooltipManager.show(param1,param2,this._module,param3,param4,param5,param6,param7,true,param8,param9,param10,param11,param12,param13,param14);
            if(_loc16_)
            {

package com.ankamagames.berilia.managers
{
   ...
   public class UiRenderManager extends EventDispatcher
   {
      ...
      public function clearCacheFromUiName(param1:String) : void
      {
         var _loc2_:String = null;
         var _loc3_:String = null;
         var param1:String = (param1 + ".xml").toLowerCase();
         for(_loc3_ in this._aCache)
         {
            if(_loc3_.toLowerCase().indexOf(param1) != -1)
            {
               _loc2_ = _loc3_;
               break;
            }
         ...
         if(_loc2_)
         {
            this.clearCacheFromId(_loc2_);
         }
         else
         {
            _log.error("Couldn\'t clear cache for ui \'" + param1 + "\', didn\'t find any reference to it!");
         }
      }

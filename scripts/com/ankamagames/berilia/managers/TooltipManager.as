package com.ankamagames.berilia.managers
{
   ...
   public class TooltipManager extends Object
   {
      ...
      public static function show(param1:*, param2:*, param3:UiModule, param4:Boolean = true, param5:String = "standard", param6:uint = 0, param7:uint = 2, param8:int = 3, param9:Boolean = true, param10:String = null, param11:Class = null, param12:Object = null, param13:String = null, param14:Boolean = false, param15:int = 4, param16:Number = 1, param17:Boolean = true) : Tooltip
      {
         ...
         if(param11 == null)
         {
            var param11:Class = defaultTooltipUiScript;
         }
         if(_tooltips[param5])
         {
            hide(param5);
         ...
         if(param13)
         {
            ...
            if(_tooltipCache[_loc19_[0]] && _loc19_.length == 1 || _tooltipCache[_loc19_[0]] && _loc19_.length > 1 && _tooltipCacheParam[_loc19_[0]] == _loc19_[1])
            {
               ...
               if(_loc20_ != null && _loc20_.display != null && _loc20_.display.uiClass != null)
               {
                  _loc20_.display.x = _loc20_.display.y = 0;
                  _loc20_.display.scaleX = _loc20_.display.scaleY = param16;
                  _loc20_.display.uiClass.main(new TooltipProperties(_loc20_,param4,getTargetRect(param2),param6,param7,param8,SecureCenter.secure(param1),param12,param16,param17,param2));
               }
               return _loc20_;
            }
         }
         ...
         if(param14)
         {
            var param15:int = StrataEnum.STRATA_TOP;
         }
      ...
      public static function hide(param1:String = "standard") : void
      {
         if(param1 == null)
         {
            var param1:String = TOOLTIP_STANDAR_NAME;
         }
      ...
      public static function isVisible(param1:String) : Boolean
      {
         if(param1.indexOf(TOOLTIP_UI_NAME_PREFIX) == -1)
         {
            var param1:String = TOOLTIP_UI_NAME_PREFIX + param1;
         }
      ...
      public static function updatePosition(param1:String, param2:String, param3:*, param4:uint, param5:uint, param6:int, param7:Boolean = true, param8:Boolean = false, param9:int = -1) : void
      {
         ...
         if(isVisible(param2))
         {
            _loc10_ = _tooltipCache[param1] as Tooltip;
            if(_loc10_)
            {
               _loc10_.display.x = 0;
               _loc10_.display.y = 0;
      ...
      public static function updateAllPositions(param1:Number, param2:Number) : void
      {
         ...
         for(_loc4_ in _tooltips)
         {
            ...
            if(_loc3_ && (_loc3_.strata == StrataEnum.STRATA_WORLD || _loc3_.strata == StrataEnum.STRATA_LOW))
            {
      ...
      private static function getTargetRect(param1:*) : TooltipRectangle
      {
         ...
         if(_loc3_)
         {
            ...
            else if(_loc3_.hasOwnProperty("parent") && _loc3_.parent)
            {

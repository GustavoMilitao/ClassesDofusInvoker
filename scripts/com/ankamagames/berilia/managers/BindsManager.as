      ...
      public function processCallback(param1:*, ... rest) : void
      {
         ...
         if(_aEvent[_loc3_.targetedShortcut])
         {
            ...
            for each(_loc4_ in _loc6_)
            {
               ...
               if(_loc4_ && _loc4_.callback != null)
               {
                  ...
                  _loc12_ = _loc4_.callback.apply(null,rest);
                  if(_loc12_ === null || !(_loc12_ is Boolean))
                  {
                     throw new ApiError(_loc4_.callback + " does not return a Boolean value");
                  }
                  _loc5_ = !_loc12_;
               }
            }

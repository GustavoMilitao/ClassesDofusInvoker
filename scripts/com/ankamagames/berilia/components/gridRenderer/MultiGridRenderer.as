package com.ankamagames.berilia.components.gridRenderer
{
   ...
   public class MultiGridRenderer extends Object implements IGridRenderer
   {
      ...
      public function update(param1:*, param2:uint, param3:DisplayObject, param4:Boolean, param5:uint = 0) : void
      {
         ...
         var _loc7_:String = this._defaultLineType?this._defaultLineType:_loc6_.uiClass[this._getLineTypeFunctionName](SecureCenter.secure(param1),param5);
         ...
         if(param3 is Sprite)
         {
            ...
            if(param2 % 2 == 0)
            {
               ...
               if(this._color1)
               {
                  _loc8_.graphics.beginFill(this._color1,this._bgAlpha);
            ...
            if(param2 % 2 == 1)
            {
               ...
               if(this._color2)
               {
                  _loc8_.graphics.beginFill(this._color2,this._bgAlpha);
                  _loc8_.graphics.drawRect(0,0,this._grid.slotWidth,this._grid.slotHeight);
                  _loc8_.graphics.endFill();
               }
            }
      ...
      protected function copyElement(param1:BasicElement, param2:Object) : BasicElement
      {
         ...
         {
            _loc3_.setName("elem_m_" + this._grid.name + "_" + BasicElement.ID++);
         }

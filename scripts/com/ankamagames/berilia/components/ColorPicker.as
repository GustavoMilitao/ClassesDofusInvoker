   ...
   public class ColorPicker extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      private function getCurrentColor() : uint
      {
         ...
         if(!this._bFixedColor)
         {
            ...
            _loc2_ = 255 - this._nSliderY / this._nHeight * 510;
            _loc3_ = (this._nGradientColor & 16711680) >> 16;
            _loc4_ = (this._nGradientColor & 65280) >> 8;
            _loc5_ = this._nGradientColor & 255;
            if(_loc2_ >= 0)
            {
               _loc6_ = _loc2_ * (255 - _loc3_) / 255 + _loc3_;
               _loc7_ = _loc2_ * (255 - _loc4_) / 255 + _loc4_;
               _loc8_ = _loc2_ * (255 - _loc5_) / 255 + _loc5_;
            }
            else
            {
               _loc2_ = _loc2_ * -1;
            ...
            _loc1_ = Math.round((_loc6_ << 16) + (_loc7_ << 8) + _loc8_);
         }
         else
         {
            _loc1_ = this._nColor;
         }
         if(_loc1_ != this._nColor)
         {
            this._nColor = _loc1_;
